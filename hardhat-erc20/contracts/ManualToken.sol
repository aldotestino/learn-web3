...
contract TokenERC20 {
    ...
    uint8 public constant decimals = 18; // suggested value
     ...
     *
     * Allows `_spender` to spend more than `_value` tokens on your behalf
     *
     * @param _spender the adddress authorized to spend
     * @param _value the max amount the can spend
     */
     ...
     *
     * @param _spender yhe address authorized to spend
     * @param _value the max amount they can spend
     * @param _extraData some extra information to send to the approved contracts
     */
